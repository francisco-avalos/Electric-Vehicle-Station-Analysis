...
## tables of importance: 
## R1
# std_co_location_activity_v2_r1
# co_location_activity_sf_r1
# co_location_activity_sf_std_r1
## R2
# std_co_location_activity_v2_r2
# co_location_activity_sf_r2
# co_location_activity_sf_std_r2
## R3
# std_co_location_activity_v2_r3
# co_location_activity_sf_r3
# co_location_activity_sf_std_r3
## R4
# std_co_location_activity_v2_r4
# co_location_activity_sf_r4
# co_location_activity_sf_std_r4
...
## tables of importance: 
## R1
# std_wa_location_activity_v2_r1
# wa_location_activity_sf_r1
# wa_location_activity_sf_std_r1
## R2
# std_wa_location_activity_v2_r2
# wa_location_activity_sf_r2
# wa_location_activity_sf_std_r2
## R3
# std_wa_location_activity_v2_r3
# wa_location_activity_sf_r3
# wa_location_activity_sf_std_r3
## R4
# std_wa_location_activity_v2_r4
# wa_location_activity_sf_r4
# wa_location_activity_sf_std_r4
...
#             bootstrapped.sampled.variograms$distance<=0.03013918~2,
#             bootstrapped.sampled.variograms$distance<=0.04013918~3,
#             bootstrapped.sampled.variograms$distance<=0.05013918~4,
#             bootstrapped.sampled.variograms$distance<=0.06013918~5,
#             bootstrapped.sampled.variograms$distance<=0.07013918~6,
#             bootstrapped.sampled.variograms$distance<=0.08013918~7,
#             bootstrapped.sampled.variograms$distance<=0.09013918~8,
#             bootstrapped.sampled.variograms$distance<=0.10013918~9,
#             bootstrapped.sampled.variograms$distance<=0.11013918~10,
#             bootstrapped.sampled.variograms$distance<=0.12013918~11,
#             bootstrapped.sampled.variograms$distance<=0.13013918~12,
#             bootstrapped.sampled.variograms$distance<=0.14013918~13,
#             bootstrapped.sampled.variograms$distance<=0.15013918~14,
#             bootstrapped.sampled.variograms$distance<=0.16013918~15,
#             bootstrapped.sampled.variograms$distance<=0.17013918~16,
#             bootstrapped.sampled.variograms$distance<=0.18013918~17,
#             bootstrapped.sampled.variograms$distance<=0.19013918~18,
#             bootstrapped.sampled.variograms$distance<=0.20013918~19,
#             bootstrapped.sampled.variograms$distance<=0.21013918~20,
#             bootstrapped.sampled.variograms$distance<=0.22013918~21,
#             bootstrapped.sampled.variograms$distance<=0.23013918~22,
#             bootstrapped.sampled.variograms$distance<=0.24013918~23,
#             bootstrapped.sampled.variograms$distance<=0.25013918~24,
#             bootstrapped.sampled.variograms$distance<=0.26013918~25,
#             bootstrapped.sampled.variograms$distance<=0.27013918~26,
#             bootstrapped.sampled.variograms$distance<=0.28013918~27,
#             bootstrapped.sampled.variograms$distance<=0.29013918~28,
#             bootstrapped.sampled.variograms$distance<=0.30013918~29,
#             bootstrapped.sampled.variograms$distance<=0.31013918~30,
#             bootstrapped.sampled.variograms$distance<=0.32013918~31,
#             bootstrapped.sampled.variograms$distance<=0.33013918~32,
#             bootstrapped.sampled.variograms$distance<=0.34013918~33,
#             bootstrapped.sampled.variograms$distance<=0.35013918~34,
#             bootstrapped.sampled.variograms$distance<=0.36013918~35,
#             bootstrapped.sampled.variograms$distance<=0.37013918~36,
#             bootstrapped.sampled.variograms$distance<=0.38013918~37,
#             bootstrapped.sampled.variograms$distance<=0.39013918~38,
#             bootstrapped.sampled.variograms$distance<=0.40013918~39,
#             bootstrapped.sampled.variograms$distance<=0.41013918~40,
#             bootstrapped.sampled.variograms$distance<=0.42013918~41,
#             bootstrapped.sampled.variograms$distance<=0.43013918~42,
#             bootstrapped.sampled.variograms$distance<=0.44013918~43,
#             bootstrapped.sampled.variograms$distance<=0.45013918~44,
#             bootstrapped.sampled.variograms$distance<=0.46013918~45,
#             bootstrapped.sampled.variograms$distance<=0.47013918~46,
#             bootstrapped.sampled.variograms$distance<=0.48013918~47,
#             bootstrapped.sampled.variograms$distance<=0.49013918~48,
#             bootstrapped.sampled.variograms$distance<=0.50013918~49,
#             bootstrapped.sampled.variograms$distance<=0.51013918~50,
#             bootstrapped.sampled.variograms$distance<=0.52013918~51,
#             bootstrapped.sampled.variograms$distance<=0.53013918~52,
#             bootstrapped.sampled.variograms$distance<=0.54013918~53,
#             bootstrapped.sampled.variograms$distance<=0.55013918~54,
#             bootstrapped.sampled.variograms$distance<=0.56013918~55,
#             bootstrapped.sampled.variograms$distance<=0.57013918~56,
#             bootstrapped.sampled.variograms$distance<=0.58013918~57,
#             bootstrapped.sampled.variograms$distance<=0.59013918~58,
#             bootstrapped.sampled.variograms$distance<=0.60013918~59,
#             bootstrapped.sampled.variograms$distance<=0.61013918~60,
#             bootstrapped.sampled.variograms$distance<=0.62013918~61,
#             bootstrapped.sampled.variograms$distance<=0.63013918~62,
#             bootstrapped.sampled.variograms$distance<=0.64013918~63,
#             bootstrapped.sampled.variograms$distance<=0.65013918~64,
#             bootstrapped.sampled.variograms$distance<=0.66013918~65,
#             bootstrapped.sampled.variograms$distance<=0.67013918~66,
#             bootstrapped.sampled.variograms$distance<=0.68013918~67,
#             bootstrapped.sampled.variograms$distance<=0.69013918~68,
#             bootstrapped.sampled.variograms$distance<=0.70013918~69,
#             bootstrapped.sampled.variograms$distance<=0.71013918~70,
#             bootstrapped.sampled.variograms$distance<=0.72013918~71,
#             bootstrapped.sampled.variograms$distance<=0.73013918~72,
#             bootstrapped.sampled.variograms$distance<=0.74013918~73,
#             bootstrapped.sampled.variograms$distance<=0.75013918~74,
#             bootstrapped.sampled.variograms$distance<=0.76013918~75,
#             bootstrapped.sampled.variograms$distance<=0.77013918~76,
#             bootstrapped.sampled.variograms$distance<=0.78013918~77,
#             bootstrapped.sampled.variograms$distance<=0.79013918~78,
#             bootstrapped.sampled.variograms$distance<=0.80013918~79,
#             bootstrapped.sampled.variograms$distance<=0.81013918~80,
#             bootstrapped.sampled.variograms$distance<=0.82013918~81,
#             bootstrapped.sampled.variograms$distance<=0.83013918~82,
#             bootstrapped.sampled.variograms$distance<=0.84013918~83,
#             bootstrapped.sampled.variograms$distance<=0.85013918~84,
#             bootstrapped.sampled.variograms$distance<=0.86013918~85,
#             bootstrapped.sampled.variograms$distance<=0.87013918~86,
#             bootstrapped.sampled.variograms$distance<=0.88013918~87,
#             bootstrapped.sampled.variograms$distance<=0.89013918~88,
#             bootstrapped.sampled.variograms$distance<=0.90013918~89,
#             bootstrapped.sampled.variograms$distance<=0.91013918~90,
#             bootstrapped.sampled.variograms$distance<=0.92013918~91,
#             bootstrapped.sampled.variograms$distance<=0.93013918~92,
#             bootstrapped.sampled.variograms$distance<=0.94013918~93,
#             bootstrapped.sampled.variograms$distance<=0.95013918~94,
#             bootstrapped.sampled.variograms$distance<=0.96013918~95,
#             bootstrapped.sampled.variograms$distance<=0.97013918~96,
#             bootstrapped.sampled.variograms$distance<=0.98013918~97,
#             bootstrapped.sampled.variograms$distance<=0.99013918~98,
#             bootstrapped.sampled.variograms$distance<=1.00013918~99,
#             bootstrapped.sampled.variograms$distance<=1.01013918~100,
#             bootstrapped.sampled.variograms$distance<=1.02013918~101,
#             bootstrapped.sampled.variograms$distance<=1.03013918~102,
#             bootstrapped.sampled.variograms$distance<=1.04013918~103,
#             bootstrapped.sampled.variograms$distance<=1.05013918~104,
#             bootstrapped.sampled.variograms$distance<=1.06013918~105,
#             bootstrapped.sampled.variograms$distance<=1.07013918~106,
#             bootstrapped.sampled.variograms$distance<=1.08013918~107,
#             bootstrapped.sampled.variograms$distance<=1.09013918~108,
#             bootstrapped.sampled.variograms$distance<=1.10013918~109,
#             bootstrapped.sampled.variograms$distance<=1.11013918~110,
#             bootstrapped.sampled.variograms$distance<=1.12013918~111,
#             bootstrapped.sampled.variograms$distance<=1.13013918~112,
#             bootstrapped.sampled.variograms$distance<=1.14013918~113,
#             bootstrapped.sampled.variograms$distance<=1.15013918~114,
#             bootstrapped.sampled.variograms$distance<=1.16013918~115,
#             bootstrapped.sampled.variograms$distance<=1.17013918~116,
#             bootstrapped.sampled.variograms$distance<=1.18013918~117,
#             TRUE~118)

# bootstrapped.sampled.variograms$dist.bins <-
#   case_when(bootstrapped.sampled.variograms$distance<= 0.02013918 ~1,
#             bootstrapped.sampled.variograms$distance<= 0.04013918 ~2,
#             bootstrapped.sampled.variograms$distance<= 0.06013918 ~3,
#             bootstrapped.sampled.variograms$distance<= 0.08013918 ~4,
#             bootstrapped.sampled.variograms$distance<= 0.10013918 ~5,
#             bootstrapped.sampled.variograms$distance<= 0.12013918 ~6,
#             bootstrapped.sampled.variograms$distance<= 0.14013918 ~7,
#             bootstrapped.sampled.variograms$distance<= 0.16013918 ~8,
#             bootstrapped.sampled.variograms$distance<= 0.18013918 ~9,
#             bootstrapped.sampled.variograms$distance<= 0.20013918 ~10,
#             bootstrapped.sampled.variograms$distance<= 0.22013918 ~11,
#             bootstrapped.sampled.variograms$distance<= 0.24013918 ~12,
#             bootstrapped.sampled.variograms$distance<= 0.26013918 ~13,
#             bootstrapped.sampled.variograms$distance<= 0.28013918 ~14,
#             bootstrapped.sampled.variograms$distance<= 0.30013918 ~15,
#             bootstrapped.sampled.variograms$distance<= 0.32013918 ~16,
#             bootstrapped.sampled.variograms$distance<= 0.34013918 ~17,
#             bootstrapped.sampled.variograms$distance<= 0.36013918 ~18,
#             bootstrapped.sampled.variograms$distance<= 0.38013918 ~19,
#             bootstrapped.sampled.variograms$distance<= 0.40013918 ~20,
#             bootstrapped.sampled.variograms$distance<= 0.42013918 ~21,
#             bootstrapped.sampled.variograms$distance<= 0.44013918 ~22,
#             bootstrapped.sampled.variograms$distance<= 0.46013918 ~23,
#             bootstrapped.sampled.variograms$distance<= 0.48013918 ~24,
#             bootstrapped.sampled.variograms$distance<= 0.50013918 ~25,
#             bootstrapped.sampled.variograms$distance<= 0.52013918 ~26,
#             bootstrapped.sampled.variograms$distance<= 0.54013918 ~27,
#             bootstrapped.sampled.variograms$distance<= 0.56013918 ~28,
#             bootstrapped.sampled.variograms$distance<= 0.58013918 ~29,
#             bootstrapped.sampled.variograms$distance<= 0.60013918 ~30,
#             bootstrapped.sampled.variograms$distance<= 0.62013918 ~31,
#             bootstrapped.sampled.variograms$distance<= 0.64013918 ~32,
#             bootstrapped.sampled.variograms$distance<= 0.66013918 ~33,
#             bootstrapped.sampled.variograms$distance<= 0.68013918 ~34,
#             bootstrapped.sampled.variograms$distance<= 0.70013918 ~35,
#             bootstrapped.sampled.variograms$distance<= 0.72013918 ~36,
#             bootstrapped.sampled.variograms$distance<= 0.74013918 ~37,
#             bootstrapped.sampled.variograms$distance<= 0.76013918 ~38,
#             bootstrapped.sampled.variograms$distance<= 0.78013918 ~39,
#             bootstrapped.sampled.variograms$distance<= 0.80013918 ~40,
#             bootstrapped.sampled.variograms$distance<= 0.82013918 ~41,
#             bootstrapped.sampled.variograms$distance<= 0.84013918 ~42,
#             bootstrapped.sampled.variograms$distance<= 0.86013918 ~43,
#             bootstrapped.sampled.variograms$distance<= 0.88013918 ~44,
#             bootstrapped.sampled.variograms$distance<= 0.90013918 ~45,
#             bootstrapped.sampled.variograms$distance<= 0.92013918 ~46,
#             bootstrapped.sampled.variograms$distance<= 0.94013918 ~47,
#             bootstrapped.sampled.variograms$distance<= 0.96013918 ~48,
#             bootstrapped.sampled.variograms$distance<= 0.98013918 ~49,
#             bootstrapped.sampled.variograms$distance<= 1.00013918 ~50,
#             bootstrapped.sampled.variograms$distance<= 1.02013918 ~51,
#             bootstrapped.sampled.variograms$distance<= 1.04013918 ~52,
#             bootstrapped.sampled.variograms$distance<= 1.06013918 ~53,
#             bootstrapped.sampled.variograms$distance<= 1.08013918 ~54,
#             bootstrapped.sampled.variograms$distance<= 1.10013918 ~55,
#             bootstrapped.sampled.variograms$distance<= 1.12013918 ~56,
#             bootstrapped.sampled.variograms$distance<= 1.14013918 ~57,
#             bootstrapped.sampled.variograms$distance<= 1.16013918 ~58,
#             bootstrapped.sampled.variograms$distance<= 1.18013918 ~59,
#             TRUE~60)
# bootstrapped.sampled.variograms$dist.bins <- 
#   case_when(bootstrapped.sampled.variograms$distance<=0.02013918 ~1,
#             bootstrapped.sampled.variograms$distance<=0.06013918 ~2,
#             bootstrapped.sampled.variograms$distance<=0.10013918 ~3,
#             bootstrapped.sampled.variograms$distance<=0.14013918 ~4,
#             bootstrapped.sampled.variograms$distance<=0.18013918 ~5,
#             bootstrapped.sampled.variograms$distance<=0.22013918 ~6,
#             bootstrapped.sampled.variograms$distance<=0.26013918 ~7,
#             bootstrapped.sampled.variograms$distance<=0.30013918 ~8,
#             bootstrapped.sampled.variograms$distance<=0.34013918 ~9,
#             bootstrapped.sampled.variograms$distance<=0.38013918 ~10,
#             bootstrapped.sampled.variograms$distance<=0.42013918~11,
#             bootstrapped.sampled.variograms$distance<=0.46013918 ~12,
#             bootstrapped.sampled.variograms$distance<=0.50013918 ~13,
#             bootstrapped.sampled.variograms$distance<=0.54013918 ~14,
#             bootstrapped.sampled.variograms$distance<=0.58013918 ~15,
#             bootstrapped.sampled.variograms$distance<=0.62013918 ~16,
#             bootstrapped.sampled.variograms$distance<=0.66013918 ~17,
#             bootstrapped.sampled.variograms$distance<=0.70013918 ~18,
#             bootstrapped.sampled.variograms$distance<=0.74013918 ~19,
#             bootstrapped.sampled.variograms$distance<=0.78013918 ~20,
#             bootstrapped.sampled.variograms$distance<=0.82013918 ~21,
#             bootstrapped.sampled.variograms$distance<=0.86013918~22,
#             bootstrapped.sampled.variograms$distance<=0.90013918 ~23,
#             bootstrapped.sampled.variograms$distance<=0.94013918 ~24,
#             bootstrapped.sampled.variograms$distance<=0.98013918 ~25,
#             bootstrapped.sampled.variograms$distance<=1.02013918 ~26,
#             bootstrapped.sampled.variograms$distance<=1.06013918 ~27,
#             bootstrapped.sampled.variograms$distance<=1.10013918 ~28,
#             bootstrapped.sampled.variograms$distance<=1.14013918 ~29,
#             bootstrapped.sampled.variograms$distance<=1.18013918~30,
#             TRUE~31)
bootstrapped.sampled.variograms$dist.bins <-
  case_when(bootstrapped.sampled.variograms$distance<=0.02013918 ~1,
...
# bootstrapped.sampled.variograms$dist.bins <- 
#   case_when(bootstrapped.sampled.variograms$distance<=0.02013918 ~1,
#             bootstrapped.sampled.variograms$distance<=0.13013918 ~2,
#             bootstrapped.sampled.variograms$distance<=0.24013918 ~3,
#             bootstrapped.sampled.variograms$distance<=0.35013918 ~4,
#             bootstrapped.sampled.variograms$distance<=0.46013918 ~5,
#             bootstrapped.sampled.variograms$distance<=0.57013918 ~6,
#             bootstrapped.sampled.variograms$distance<=0.68013918 ~7,
#             bootstrapped.sampled.variograms$distance<=0.79013918 ~8,
#             bootstrapped.sampled.variograms$distance<=0.90013918 ~9,
#             bootstrapped.sampled.variograms$distance<=1.01013918 ~10,
#             bootstrapped.sampled.variograms$distance<=1.12013918~11,
#             TRUE~12)
...
#             ev.station.variogram$dist<=0.13013918 ~2,
#             ev.station.variogram$dist<=0.24013918 ~3,
#             ev.station.variogram$dist<=0.35013918 ~4,
#             ev.station.variogram$dist<=0.46013918 ~5,
#             ev.station.variogram$dist<=0.57013918 ~6,
#             ev.station.variogram$dist<=0.68013918 ~7,
#             ev.station.variogram$dist<=0.79013918 ~8,
#             ev.station.variogram$dist<=0.90013918 ~9,
#             ev.station.variogram$dist<=1.01013918 ~10,
#             ev.station.variogram$dist<=1.12013918~11,
#             TRUE~12)
ev.station.variogram$dist.bins <-
  case_when(ev.station.variogram$dist<=0.02013918 ~1,
...
# ev.station.variogram$dist.bins <- 
#   case_when(ev.station.variogram$dist<=0.02013918 ~1,
#             ev.station.variogram$dist<=0.06013918 ~2,
#             ev.station.variogram$dist<=0.10013918 ~3,
#             ev.station.variogram$dist<=0.14013918 ~4,
#             ev.station.variogram$dist<=0.18013918 ~5,
#             ev.station.variogram$dist<=0.22013918 ~6,
#             ev.station.variogram$dist<=0.26013918 ~7,
#             ev.station.variogram$dist<=0.30013918 ~8,
#             ev.station.variogram$dist<=0.34013918 ~9,
#             ev.station.variogram$dist<=0.38013918 ~10,
#             ev.station.variogram$dist<=0.42013918~11,
#             ev.station.variogram$dist<=0.46013918 ~12,
#             ev.station.variogram$dist<=0.50013918 ~13,
#             ev.station.variogram$dist<=0.54013918 ~14,
#             ev.station.variogram$dist<=0.58013918 ~15,
#             ev.station.variogram$dist<=0.62013918 ~16,
#             ev.station.variogram$dist<=0.66013918 ~17,
#             ev.station.variogram$dist<=0.70013918 ~18,
#             ev.station.variogram$dist<=0.74013918 ~19,
#             ev.station.variogram$dist<=0.78013918 ~20,
#             ev.station.variogram$dist<=0.82013918 ~21,
#             ev.station.variogram$dist<=0.86013918~22,
#             ev.station.variogram$dist<=0.90013918 ~23,
#             ev.station.variogram$dist<=0.94013918 ~24,
#             ev.station.variogram$dist<=0.98013918 ~25,
#             ev.station.variogram$dist<=1.02013918 ~26,
#             ev.station.variogram$dist<=1.06013918 ~27,
#             ev.station.variogram$dist<=1.10013918 ~28,
#             ev.station.variogram$dist<=1.14013918 ~29,
#             ev.station.variogram$dist<=1.18013918~30,
#             TRUE~31)
# ev.station.variogram$dist.bins <-
#   case_when(ev.station.variogram$dist<= 0.02013918 ~1,
#             ev.station.variogram$dist<= 0.04013918 ~2,
#             ev.station.variogram$dist<= 0.06013918 ~3,
#             ev.station.variogram$dist<= 0.08013918 ~4,
#             ev.station.variogram$dist<= 0.10013918 ~5,
#             ev.station.variogram$dist<= 0.12013918 ~6,
#             ev.station.variogram$dist<= 0.14013918 ~7,
#             ev.station.variogram$dist<= 0.16013918 ~8,
#             ev.station.variogram$dist<= 0.18013918 ~9,
#             ev.station.variogram$dist<= 0.20013918 ~10,
#             ev.station.variogram$dist<= 0.22013918 ~11,
#             ev.station.variogram$dist<= 0.24013918 ~12,
#             ev.station.variogram$dist<= 0.26013918 ~13,
#             ev.station.variogram$dist<= 0.28013918 ~14,
#             ev.station.variogram$dist<= 0.30013918 ~15,
#             ev.station.variogram$dist<= 0.32013918 ~16,
#             ev.station.variogram$dist<= 0.34013918 ~17,
#             ev.station.variogram$dist<= 0.36013918 ~18,
#             ev.station.variogram$dist<= 0.38013918 ~19,
#             ev.station.variogram$dist<= 0.40013918 ~20,
#             ev.station.variogram$dist<= 0.42013918 ~21,
#             ev.station.variogram$dist<= 0.44013918 ~22,
#             ev.station.variogram$dist<= 0.46013918 ~23,
#             ev.station.variogram$dist<= 0.48013918 ~24,
#             ev.station.variogram$dist<= 0.50013918 ~25,
#             ev.station.variogram$dist<= 0.52013918 ~26,
#             ev.station.variogram$dist<= 0.54013918 ~27,
#             ev.station.variogram$dist<= 0.56013918 ~28,
#             ev.station.variogram$dist<= 0.58013918 ~29,
#             ev.station.variogram$dist<= 0.60013918 ~30,
#             ev.station.variogram$dist<= 0.62013918 ~31,
#             ev.station.variogram$dist<= 0.64013918 ~32,
#             ev.station.variogram$dist<= 0.66013918 ~33,
#             ev.station.variogram$dist<= 0.68013918 ~34,
#             ev.station.variogram$dist<= 0.70013918 ~35,
#             ev.station.variogram$dist<= 0.72013918 ~36,
#             ev.station.variogram$dist<= 0.74013918 ~37,
#             ev.station.variogram$dist<= 0.76013918 ~38,
#             ev.station.variogram$dist<= 0.78013918 ~39,
#             ev.station.variogram$dist<= 0.80013918 ~40,
#             ev.station.variogram$dist<= 0.82013918 ~41,
#             ev.station.variogram$dist<= 0.84013918 ~42,
#             ev.station.variogram$dist<= 0.86013918 ~43,
#             ev.station.variogram$dist<= 0.88013918 ~44,
#             ev.station.variogram$dist<= 0.90013918 ~45,
#             ev.station.variogram$dist<= 0.92013918 ~46,
#             ev.station.variogram$dist<= 0.94013918 ~47,
#             ev.station.variogram$dist<= 0.96013918 ~48,
#             ev.station.variogram$dist<= 0.98013918 ~49,
#             ev.station.variogram$dist<= 1.00013918 ~50,
#             ev.station.variogram$dist<= 1.02013918 ~51,
#             ev.station.variogram$dist<= 1.04013918 ~52,
#             ev.station.variogram$dist<= 1.06013918 ~53,
#             ev.station.variogram$dist<= 1.08013918 ~54,
#             ev.station.variogram$dist<= 1.10013918 ~55,
#             ev.station.variogram$dist<= 1.12013918 ~56,
#             ev.station.variogram$dist<= 1.14013918 ~57,
#             ev.station.variogram$dist<= 1.16013918 ~58,
#             ev.station.variogram$dist<= 1.18013918 ~59,
#             TRUE~60)

# ev.station.variogram$dist.bins <- 
#   case_when(ev.station.variogram$dist<=0.02013918~1,
#             ev.station.variogram$dist<=0.03013918~2,
#             ev.station.variogram$dist<=0.04013918~3,
#             ev.station.variogram$dist<=0.05013918~4,
#             ev.station.variogram$dist<=0.06013918~5,
#             ev.station.variogram$dist<=0.07013918~6,
#             ev.station.variogram$dist<=0.08013918~7,
#             ev.station.variogram$dist<=0.09013918~8,
#             ev.station.variogram$dist<=0.10013918~9,
#             ev.station.variogram$dist<=0.11013918~10,
#             ev.station.variogram$dist<=0.12013918~11,
#             ev.station.variogram$dist<=0.13013918~12,
#             ev.station.variogram$dist<=0.14013918~13,
#             ev.station.variogram$dist<=0.15013918~14,
#             ev.station.variogram$dist<=0.16013918~15,
#             ev.station.variogram$dist<=0.17013918~16,
#             ev.station.variogram$dist<=0.18013918~17,
#             ev.station.variogram$dist<=0.19013918~18,
#             ev.station.variogram$dist<=0.20013918~19,
#             ev.station.variogram$dist<=0.21013918~20,
#             ev.station.variogram$dist<=0.22013918~21,
#             ev.station.variogram$dist<=0.23013918~22,
#             ev.station.variogram$dist<=0.24013918~23,
#             ev.station.variogram$dist<=0.25013918~24,
#             ev.station.variogram$dist<=0.26013918~25,
#             ev.station.variogram$dist<=0.27013918~26,
#             ev.station.variogram$dist<=0.28013918~27,
#             ev.station.variogram$dist<=0.29013918~28,
#             ev.station.variogram$dist<=0.30013918~29,
#             ev.station.variogram$dist<=0.31013918~30,
#             ev.station.variogram$dist<=0.32013918~31,
#             ev.station.variogram$dist<=0.33013918~32,
#             ev.station.variogram$dist<=0.34013918~33,
#             ev.station.variogram$dist<=0.35013918~34,
#             ev.station.variogram$dist<=0.36013918~35,
#             ev.station.variogram$dist<=0.37013918~36,
#             ev.station.variogram$dist<=0.38013918~37,
#             ev.station.variogram$dist<=0.39013918~38,
#             ev.station.variogram$dist<=0.40013918~39,
#             ev.station.variogram$dist<=0.41013918~40,
#             ev.station.variogram$dist<=0.42013918~41,
#             ev.station.variogram$dist<=0.43013918~42,
#             ev.station.variogram$dist<=0.44013918~43,
#             ev.station.variogram$dist<=0.45013918~44,
#             ev.station.variogram$dist<=0.46013918~45,
#             ev.station.variogram$dist<=0.47013918~46,
#             ev.station.variogram$dist<=0.48013918~47,
#             ev.station.variogram$dist<=0.49013918~48,
#             ev.station.variogram$dist<=0.50013918~49,
#             ev.station.variogram$dist<=0.51013918~50,
#             ev.station.variogram$dist<=0.52013918~51,
#             ev.station.variogram$dist<=0.53013918~52,
#             ev.station.variogram$dist<=0.54013918~53,
#             ev.station.variogram$dist<=0.55013918~54,
#             ev.station.variogram$dist<=0.56013918~55,
#             ev.station.variogram$dist<=0.57013918~56,
#             ev.station.variogram$dist<=0.58013918~57,
#             ev.station.variogram$dist<=0.59013918~58,
#             ev.station.variogram$dist<=0.60013918~59,
#             ev.station.variogram$dist<=0.61013918~60,
#             ev.station.variogram$dist<=0.62013918~61,
#             ev.station.variogram$dist<=0.63013918~62,
#             ev.station.variogram$dist<=0.64013918~63,
#             ev.station.variogram$dist<=0.65013918~64,
#             ev.station.variogram$dist<=0.66013918~65,
#             ev.station.variogram$dist<=0.67013918~66,
#             ev.station.variogram$dist<=0.68013918~67,
#             ev.station.variogram$dist<=0.69013918~68,
#             ev.station.variogram$dist<=0.70013918~69,
#             ev.station.variogram$dist<=0.71013918~70,
#             ev.station.variogram$dist<=0.72013918~71,
#             ev.station.variogram$dist<=0.73013918~72,
#             ev.station.variogram$dist<=0.74013918~73,
#             ev.station.variogram$dist<=0.75013918~74,
#             ev.station.variogram$dist<=0.76013918~75,
#             ev.station.variogram$dist<=0.77013918~76,
#             ev.station.variogram$dist<=0.78013918~77,
#             ev.station.variogram$dist<=0.79013918~78,
#             ev.station.variogram$dist<=0.80013918~79,
#             ev.station.variogram$dist<=0.81013918~80,
#             ev.station.variogram$dist<=0.82013918~81,
#             ev.station.variogram$dist<=0.83013918~82,
#             ev.station.variogram$dist<=0.84013918~83,
#             ev.station.variogram$dist<=0.85013918~84,
#             ev.station.variogram$dist<=0.86013918~85,
#             ev.station.variogram$dist<=0.87013918~86,
#             ev.station.variogram$dist<=0.88013918~87,
#             ev.station.variogram$dist<=0.89013918~88,
#             ev.station.variogram$dist<=0.90013918~89,
#             ev.station.variogram$dist<=0.91013918~90,
#             ev.station.variogram$dist<=0.92013918~91,
#             ev.station.variogram$dist<=0.93013918~92,
#             ev.station.variogram$dist<=0.94013918~93,
#             ev.station.variogram$dist<=0.95013918~94,
#             ev.station.variogram$dist<=0.96013918~95,
#             ev.station.variogram$dist<=0.97013918~96,
#             ev.station.variogram$dist<=0.98013918~97,
#             ev.station.variogram$dist<=0.99013918~98,
#             ev.station.variogram$dist<=1.00013918~99,
#             ev.station.variogram$dist<=1.01013918~100,
#             ev.station.variogram$dist<=1.02013918~101,
#             ev.station.variogram$dist<=1.03013918~102,
#             ev.station.variogram$dist<=1.04013918~103,
#             ev.station.variogram$dist<=1.05013918~104,
#             ev.station.variogram$dist<=1.06013918~105,
#             ev.station.variogram$dist<=1.07013918~106,
#             ev.station.variogram$dist<=1.08013918~107,
#             ev.station.variogram$dist<=1.09013918~108,
#             ev.station.variogram$dist<=1.10013918~109,
#             ev.station.variogram$dist<=1.11013918~110,
#             ev.station.variogram$dist<=1.12013918~111,
#             ev.station.variogram$dist<=1.13013918~112,
#             ev.station.variogram$dist<=1.14013918~113,
#             ev.station.variogram$dist<=1.15013918~114,
#             ev.station.variogram$dist<=1.16013918~115,
#             ev.station.variogram$dist<=1.17013918~116,
#             ev.station.variogram$dist<=1.18013918~117,
#             TRUE~118)
...
# #Fit variogram: - 
# v.fit <- fit.variogram(variogram(g),
#                        # vgm(psil=1, 'Per',nugget = 0.1, range = 0.1))
#                        vgm('Int'))
# plot(variogram(g), v.fit)
# 
# v.fit <- automap::autofitVariogram(mtbf~distance_to_nearest_charger,
#                                    as(co_location_activity_sf_std_r4, 'Spatial'))$var_model
# plot(variogram(g), v.fit)
# 
# 
# coordinates(std_co_location_activity_v2_r4) ~ x_axis_unique + y_axis_unique
# him.krig <- krige(id = 'hours_im',
#                   mtbf~distance_to_nearest_charger,
#                   locations = ~x_axis_unique+y_axis_unique,
#                   model=v.fit,
#                   data=std_co_location_activity_v2_r4,
...
# df <- SpatialPointsDataFrame(coords = xy, data=him.krig)
# gridded(df) <- TRUE
# p <- spplot(df['hours_im.pred'], main="Autofitted variogram Kriging Cold Temps - dist. to nearest charger")
# 
# p <- spplot(df['hours_im.pred'], 
#             main="Autofitted variogram Kriging Cold Temps - dist. to nearest charger + total customers")
# # print(p)
# p + latticeExtra::layer(panel.points(std_co_location_activity_v2_r4$x_axis_unique, 
#                                      std_co_location_activity_v2_r4$y_axis_unique, col='green', pch=5), 
#                         data=std_co_location_activity_v2_r4)
# ggplot(data=std_co_location_activity_v2_r4, aes(x=x_axis_unique, y=y_axis_unique)) + geom_point()
# 
# 
# ## cross-validation
# model1 <- vgm(psil=1, "Gau",nugget = 0.1, range = 0.1)
# model1 <- v.fit # autofitted
# model.type <- 'Ste'
# 
# folds <- 5
# nearest.max <- 10
# cv <- krige.cv(formula=mtbf~distance_to_nearest_charger+total_customers,
#                locations=~x_axis_unique+y_axis_unique,
#                data=std_co_location_activity_v2_r4,
#                model=model1, 
#                nmax=nearest.max, 
...
# Kriging on warm region - COLD REGION NOT PURSUED DUE TO NOT ENOUGH DATA

# # start warm region 
# # "Exp", "Sph", "Gau", "Mat"
# x.range <- as.integer(std_wa_location_activity_v2_r4$x_axis_unique)
# y.range <- as.integer(std_wa_location_activity_v2_r4$y_axis_unique)
# pred1.range <- std_wa_location_activity_v2_r4$distance_to_nearest_charger
# pred2.range <- std_wa_location_activity_v2_r4$total_customers
# 
# grd <- expand.grid(x_axis_unique=seq(from=min(x.range), to=max(x.range), by=0.01),
#                    y_axis_unique=seq(from=min(y.range), to=max(y.range), by=0.01),
#                    distance_to_nearest_charger=seq(from=min(pred1.range), to=max(pred1.range), by=0.01))
...
#                    total_customers=seq(from=min(pred2.range), to=max(pred2.range), by=0.04))
# 
# g <- gstat::gstat(id="log_response", 
#                   formula = mtbf~distance_to_nearest_charger+total_customers, 
#                   locations = ~x_axis_unique+y_axis_unique, 
#                   data = std_wa_location_activity_v2_r4)
# plot(variogram(g))
# 
# #Fit variogram: - 
# v.fit <- fit.variogram(variogram(g),
#                        # vgm(psil=0.25, "Exp", nugget = 0.04, range = 5), 
#                        vgm(psil=0.03, "Spl", nugget = 0.1, range = 0.05),
#                        # vgm(psil=0.04803644, "Ste", range = 0.0103589, kappa = 0.2), 
#                        fit.method = 1)
# plot(variogram(g), v.fit)
# 
# v.fit <- automap::autofitVariogram(mtbf~distance_to_nearest_charger,
#                                    as(wa_location_activity_sf_std_r4, 'Spatial'))$var_model
# plot(variogram(g), v.fit)
#  
# ggplot(data=wa_df, aes(x=x_axis_unique, y=y_axis_unique)) + geom_point()
# 
# coordinates(std_wa_location_activity_v2) ~ x_axis_unique + y_axis_unique
# him.krig <- krige(id='hours_im',
#                   total_hours_in_maintenance~distance_to_nearest_charger,
#                   locations = ~x_axis_unique+y_axis_unique,
#                   model=v.fit,
#                   data=std_wa_location_activity_v2,
#                   newdata=grd)
# xy <- him.krig[,c(1,2)]
# df <- SpatialPointsDataFrame(coords = xy, data=him.krig)
# gridded(df) <- TRUE
# spplot(df['hours_im.pred'])
...
################################################################################
################### Poisson Count Regression Model - From Advanced Regression
###################

library(MASS)
head(location_activity)

cols <- c("station_id", "station_intances_adj", "charger_company_col", 
          "minutes_diff", 
          "session_start_date", "sessions", "minutes",    
          "session_kwh", "unique_customers", 
          "bucketed_im_minutes", "bucketed_im_minutes.v10", "day_count",
          "running.im.now", "running.im.adj.now", "mtbf_flag",
          "im_flag", "period_count",
          "remaining_days",
          "temps", "x_axis", "y_axis", "temp_class",
          "uptime_minutes", "uptime_hours", "temp_region")
reduced.df <- im_df[, cols]
# to be the same as comparative my model, must remove the instance 
# the ev station went into maintenance. in this case, let's remove 
# IM rows

reduced.df <- subset(reduced.df, im_flag=='NO IM')

with(location_activity, boxcox())
...
################################################################################
################### Frequentist Weibull Distribution 
###################
...
# fit <- fitdist(wa_df$remaining_days, method = 'mle',
#                'weibull', lower=c(0,0),
#                start = list(scale = 0.5, shape = 1))

prep.wa.df <- im_df %>% 
  group_by(station_intances_adj) %>% 
  summarize(operational_days = max(remaining_days))
fit <- fitdist(prep.wa.df$operational_days, 'weibull',
               lower=c(0,0), start = list(scale=1, shape=1))
weib_shape <- fit$estimate["shape"]
weib_scale <- fit$estimate["scale"]

fit.gamma <- fitdist(prep.wa.df$operational_days, 'gamma',
                     lower=c(0,0), start = list(scale=1, shape=1))
gamm_shape <- fit.gamma$estimate["shape"]
gamm_rate <- fit.gamma$estimate["rate"]

# fit.lognormal <- fitdist(prep.wa.df$operational_days, 'lnorm')
# lognorm_meanlog <- fit.gamma$estimate["meanlog"]
# lognorm_sdlog <- fit.gamma$estimate["sdlog"]

plot.legend <- c('weibull', 'gamma')
denscomp(list(fit, fit.gamma), legendtext=plot.legend)


gofstat(list(fit, fit.gamma),
        fitnames = c('weibull', 'gamma'))

reliability_at_x_days <- exp(-(180/weib_scale) ** (weib_shape))
reliability_at_x_days
...
library(splancs)
library(spatstat)
b1 <- as.points(im_df$x_axis, im_df$y_axis)
b2 <- as.ppp(b1, W = c(0,2,0,4))
ppm(b2, polynom(x,y), Poisson())

df <- unique(wa_df$station_id)
write.csv(df, 'wa-stations.csv')



fqmplot(station_longitude, station_latitude,
       data = im_df, color=I('red'))
# xmean <- mean(im_df$station_longitude)
# ymean <- mean(im_df$station_latitude)
# points(xmean, ymean, pch=3)

qmplot(station_longitude, station_latitude,
       data = co_df, color=I('red'))
qmplot(station_longitude, station_latitude,
       data = wa_df, color=I('red'))
...
weather_stations_locations <-
   cbind(type2, im_df[, c('LATITUDE', 'LONGITUDE')])
